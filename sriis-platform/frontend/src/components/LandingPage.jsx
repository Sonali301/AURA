  ...
  return (
    <div className="bg-[#020617] text-gray-200 min-h-screen overflow-x-hidden selection:bg-neon-cyan/30 font-sans">
      ...
      <motion.section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-24 px-6 z-10" style={{ y: heroY }}>
        ...
        <div className="absolute top-0 w-full overflow-hidden border-b border-white/5 bg-black/40 backdrop-blur-md py-6 z-20">
          ...
          <motion.div variants={fadeInUp} className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-6">
            <button onClick={onLaunch} className="relative group px-10 py-5 bg-neon-cyan/10 border border-neon-cyan/50 rounded-lg overflow-hidden transition-all hover:bg-neon-cyan/20 hover:scale-105 shadow-[0_0_20px_rgba(0,240,255,0.2)]">
              ...
              <span className="relative z-10 text-neon-cyan font-bold tracking-widest uppercase flex items-center">
                Launch Global Command Center <ArrowRight size={18} className="ml-2 group-hover:translate-x-1 transition-transform" />
              </span>
            </button>
      ...
      ========================================= */}
      <section className="py-24 px-6 relative z-20 bg-black/40 border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 flex items-center justify-center"><ShieldCheck className="text-neon-green mr-4" size={36}/> Enterprise Safety Guardrails</h2>
      ...
      ========================================= */}
      <section className="py-24 px-6 relative z-20 max-w-7xl mx-auto bg-black/20 rounded-3xl border border-white/5 shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { icon: Zap, title: "Chaos Engineering", desc: "Inject controlled failures (timeouts, crashes, spikes) and test resilience directly from the dashboard." },
      ...
      <section className="py-24 px-6 relative z-20">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {["React", "TailwindCSS", "FastAPI", "MongoDB", "Pinecone", "Groq", "HuggingFace", "Socket.IO", "IsolationForest", "Framer Motion"].map((tech, i) => (
              <motion.div 
                key={i}
      ...
      <footer className="py-12 border-t border-white/10 relative z-20 bg-[#020617]">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-center">
          <div className="text-gray-500 text-sm font-mono flex items-center space-x-6">
            ...
            <span className="hover:text-white transition-colors cursor-pointer">Tech Stack</span>
