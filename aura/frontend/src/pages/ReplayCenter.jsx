  ...
  useEffect(() => {
    ...
    socketRef.current.on('replay_error', (data) => {
      ...
      setIncidentData({ 
        ...
        anomaly_summary: data.message,
        root_cause: "Demo incident not found. Please resolve an actual incident in the dashboard first to view a replay.",
        recommended_action: "Go to Dashboard -> Run Simulation -> Resolve Incident"
      });
      setIsCompleted(true);
    });
          ...
          <div className="bg-black/60 border-b border-white/5 p-5 flex justify-between items-center z-10">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-neon-cyan text-xs font-mono tracking-wider">INCIDENT_ID: {incidentId}</p>
              </div>
            </div>
